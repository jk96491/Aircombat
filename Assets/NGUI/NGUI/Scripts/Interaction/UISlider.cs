...
public class UISlider : UIProgressBar
{
    ...
    public const float SliderOnValue = .825f;
    public const float SliderOffValue = .175f;
    ...
    protected void OnPressBackground(GameObject go, bool isPressed)
    {
        ...
        {
            if (value > SliderOnValue || value >= .5f)
                value = SliderOnValue;
            else if (mValue < SliderOffValue || value < .5f)
                value = SliderOffValue;
