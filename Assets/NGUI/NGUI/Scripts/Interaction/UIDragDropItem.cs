...
public class UIDragDropItem : MonoBehaviour
{
    ...
    protected float downAccel = .02f;
    protected float upAccel = .02f;
    /// <summary>
    ...
    protected bool dragStart = false;
    ...
    protected virtual void OnDragDropStart()
    {
        ...
        mScrollBar = mParent.parent.GetComponent<UIScrollView>().verticalScrollBar;
        dragStart = true;
