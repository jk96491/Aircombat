...
public class UISpriteInspector : UIBasicSpriteEditor
{
    ...
    {
        cUISprite sprite = target as cUISprite;
        if (sprite == null)
            return;
        sprite.m_atlasType = (cUISprite.AtlasType)EditorGUILayout.EnumPopup("Atlas", sprite.m_atlasType);
        sprite.m_spriteName = EditorGUILayout.TextField("SpriteName", sprite.m_spriteName);
    }
