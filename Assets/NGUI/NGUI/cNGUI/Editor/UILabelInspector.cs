...
public class UILabelInspector : UIWidgetInspector
{
    ...
    void ShowTEXT_ID()
    {
        Rect rect = EditorGUILayout.GetControlRect(GUILayout.Height(20f));
        cUILabel clable = mLabel as cUILabel;
        if (clable != null)
            clable.TEXT_KEY = EditorGUI.TextField(rect, "Text Key", clable.TEXT_KEY);
    }
	/// <summary>
